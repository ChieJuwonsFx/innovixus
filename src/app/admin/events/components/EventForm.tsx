          ...
          <form action={formAction} className="p-8 space-y-8">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    <div className="space-y-3">
                      <label htmlFor="extend_date" className="block text-sm font-semibold text-blue-700 dark:text-blue-400">
                        Tanggal Perpanjangan <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="date"
                        name="extend_date"
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-400">
                        Tanggal perpanjangan harus setelah tanggal tutup atau tanggal buka
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 max-h-80 overflow-y-auto border-2 border-gray-200 dark:border-gray-600 shadow-sm">
                    <div className="space-y-3">
                      {levels.map(level => (
                        <label key={level.id} className="flex items-center group cursor-pointer p-2 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-200">
                          <div className="relative">
                            <input
                              type="checkbox"
                              name="level_ids"
                              ...
                              className="peer sr-only"
                            />
                            <div className="w-5 h-5 border-2 border-gray-300 dark:border-gray-500 rounded-md bg-white dark:bg-gray-700 peer-checked:bg-green-600 peer-checked:border-green-600 peer-focus:ring-2 peer-focus:ring-green-500 peer-focus:ring-opacity-50 transition-all duration-200 flex items-center justify-center">
                              <svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"/>
                              </svg>
                            </div>
                          </div>
                          <span className="ml-4 text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-200">
                            {level.name}
                          </span>
                        </label>
                      ))}
            ...
            <div className="pt-8 border-t border-gray-200 dark:border-gray-700">
              <div className="flex justify-end">
                <SubmitButton
                  label={event ? "Perbarui Event" : "Simpan Event"}
