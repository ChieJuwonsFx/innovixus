...
import { Code, Terminal, Database, Laptop, Briefcase, Rocket } from 'lucide-react';
...
export default function AuthLayout({ children, scrollable = true }: AuthLayoutProps) {
    return (
        <div className={`flex h-screen bg-white dark:bg-gray-900 ${scrollable ? 'overflow-y-auto' : 'overflow-hidden'}`}>
                ...
                <div className="relative z-30 w-full h-full flex flex-col items-center justify-center text-center">
                    <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-300 mt-4 text-md max-w-md mx-auto">
                            Platform terdepan untuk menemukan info lomba, magang, dan lowongan kerja terbaru di dunia teknologi.
                        </p>
                    </div>

                    <div className="mt-10 flex gap-x-8 text-center">
                        <div>
                            <p className="text-2xl font-bold text-slate-800 dark:text-white">1k+</p>
                            <p className="text-sm text-slate-500 dark:text-slate-400">Info Lomba</p>
                        </div>
                        <div>
                            <p className="text-2xl font-bold text-slate-800 dark:text-white">500+</p>
                            <p className="text-sm text-slate-500 dark:text-slate-400">Perusahaan</p>
                        </div>
                        <div>
            ...
            <div className={`w-full md:w-1/2 flex items-center justify-center p-6 sm:p-8 ${scrollable ? 'overflow-y-auto' : ''}`}>
